 ...
 */
final class Version20250404220242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE admin CHANGE id_admin id_admin INT AUTO_INCREMENT NOT NULL, CHANGE function_admin function_admin VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE car RENAME INDEX fk_car_warehouse TO IDX_773DE69D1059A0AA
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE admin CHANGE id_admin id_admin INT NOT NULL, CHANGE function_admin function_admin VARCHAR(100) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE car RENAME INDEX idx_773de69d1059a0aa TO fk_car_warehouse
        SQL);
        $this->addSql(<<<'SQL'
