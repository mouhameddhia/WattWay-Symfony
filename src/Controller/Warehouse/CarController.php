...
class CarController extends AbstractController
{
    ...
    #[Route('/dashboard/car/sort_price_asc', name: 'searchCar')]
    ...
    public function index(SluggerInterface $slugger, CarRepository $carRepository, BillRepository $billRepository, UserRepository $userRepository , WarehouseRepository $warehouseRepository, ManagerRegistry $doctrine, Request $request): Response
    {
        $car = new Car();
        $bill= new Bill();
        $cars = $carRepository->availableCars();
