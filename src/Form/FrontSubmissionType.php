    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('description', null, [
                ...
                'label' => $this->translator->trans('submission.description')
            ])
            ->add('status', null, [
                'data' => 'pending',
            ...
            ->add('vinCode', null, [
                ...
                'label' => $this->translator->trans('submission.vin_code')
            ])
            ->add('idUser', null, [
                'required' => true,
                'constraints' => [
                ...
                'label' => $this->translator->trans('submission.user')
            ])
            ->add('preferredContactMethod', ChoiceType::class, [
                ...
                'label' => $this->translator->trans('submission.contact_method')
            ])
            ->add('preferredAppointmentDate', DateType::class, [
                ...
                'input' => 'datetime',
                'label' => $this->translator->trans('submission.appointment_date')
            ])
        ;
    }
